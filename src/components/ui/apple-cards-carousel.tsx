    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          ...
          >
            <Icon name="move-left" className="size-6 text-gray-500" />
          </button>
          <button
            className="relative z-40 flex size-10 items-center justify-center rounded-full bg-gray-100 disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <Icon name="move-right" className="size-6 text-gray-500" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
      ...
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              <button
                className="sticky right-0 top-4 ml-auto flex size-8 items-center justify-center rounded-full bg-black dark:bg-white"
                onClick={handleClose}
              >
                <Icon
                  name="x"
                  className="size-6 text-neutral-100 dark:text-neutral-900"
                />
              </button>
              <motion.p
...
export default { BlurImage, Card, Carousel, CarouselContext };
